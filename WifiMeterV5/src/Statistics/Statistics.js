        ...
        <View>
            ...
            <View style={styles.plotContainer}>
                <View style={{flexDirection:"row"}}>
                    ...
                    <YAxis data = {data} contentInset={{top:10, bottom:5}} numberOfTicks={5} style={styles.yAxisLabel}/>
                </View>
                <XAxis data={data} contentInset={{left: 15, right: 20}} numberOfTicks={5} style={styles.xAxisLabel}/>
